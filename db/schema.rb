...
ActiveRecord::Schema.define(version: 20150304234504) do
  ...
  add_index "taggings", ["surl_id"], name: "index_taggings_on_surl_id"
  ...
  add_index "visits", ["surl_id"], name: "index_visits_on_surl_id"
